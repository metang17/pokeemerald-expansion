...
#define AI_FLAG_CLEVER_TRAINER        (AI_FLAG_BASIC_TRAINER | AI_FLAG_ASSUME_STAB | AI_FLAG_SMART_SWITCHING | AI_FLAG_SMART_MON_CHOICES | AI_FLAG_PP_STALL_PREVENTION | AI_FLAG_SMART_TERA)
#define AI_FLAG_CADE                  (AI_FLAG_SMART_TRAINER | AI_FLAG_WILL_SUICIDE)
#define AI_FLAG_PAUL                  (AI_FLAG_SMART_TRAINER | AI_FLAG_POWERFUL_STATUS | AI_FLAG_CHECK_BAD_MOVE)
